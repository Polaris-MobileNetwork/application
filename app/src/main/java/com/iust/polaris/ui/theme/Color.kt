...
val md_theme_light_surface = Color(0xFFF9F9FC) // Slightly different from background for elevation
...
val md_theme_light_surfaceTint = Color(0xFF00658E) // Usually same as primary
...
val md_theme_dark_onErrorContainer = Color(0xFFFFB4AB) // Or FFFFDAD6
val md_theme_dark_background = Color(0xFF191C1E)
val md_theme_dark_onBackground = Color(0xFFE2E2E5)
val md_theme_dark_surface = Color(0xFF111416) // Slightly different from background for elevation
val md_theme_dark_onSurface = Color(0xFFC6C6C9) // Or E2E2E5
...
val md_theme_dark_inverseOnSurface = Color(0xFF191C1E) // Or 2E3133
val md_theme_dark_inversePrimary = Color(0xFF00658E)
val md_theme_dark_surfaceTint = Color(0xFF8ACEFF) // Usually same as primary
val md_theme_dark_outlineVariant = Color(0xFF41484D)
val md_theme_dark_scrim = Color(0xFF000000)

val status_success_light = Color(0xFF22BB33)
